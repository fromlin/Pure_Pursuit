...
#define SECTION1 144// 96// 140     // SECTION1 시작 y좌표 (1.0[m]) //348
#define SECTION2 111//81//107     // SECTION2 시작 y좌표 (1.3[m]) //286.5
#define SECTION3 95//69//92     // SECTION3 시작 y좌표 (1.5[m]) //240
#define SECTIONEND 82//59//80   // SECTION3 끄ㅌ y좌표 (1.7[m]) //204
...
void Projection(const cv::Point2f &src, cv::Point2f &dst, bool direction)
{
    ...
    imagePoints.push_back(cv::Point2f(37.4,117)); //37,104 //39,123
    imagePoints.push_back(cv::Point2f(151,92.8)); // 139,103//140,123
    imagePoints.push_back(cv::Point2f(15.4,75.6));//124,62//123,77
    imagePoints.push_back(cv::Point2f(104.8,75.6));//51,63//54,78

    objectPoints.push_back(cv::Point2f(-0.3, 1.23)); //1.22//1.14
    objectPoints.push_back(cv::Point2f(0.45, 1.53)); //1.22//1.14
    objectPoints.push_back(cv::Point2f(-0.6, 1.83)); //1.82//1.74
    objectPoints.push_back(cv::Point2f(0.15, 1.83));//1.82//1.74
...
void Projection(const std::vector<cv::Point2f> &src, std::vector<cv::Point2f> &dst, bool direction)
{
    ...
    objectPoints.push_back(cv::Point2f(0.15, 1.83));
